<?php
    ...
    $params = array_diff_key($params, array('blog' => ''));
    ksort($params);
    ...
    if($hmac == $calculated_hmac){
      ...
      $getblogs = "SELECT * FROM blogs WHERE id = '".$_GET['blog']."' ";
      $blogs = $obj->select($getblogs);
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="py-5 px-20">
            ...
            <div class="grid grid-cols-1 container bg-white p-5 rounded-md border border-gray-100 shadow mt-5">
              <h1 class="text-2xl pb-3 border-b-2"><?php echo $blogs[0]['title']; ?></h1>
              <p>&nbsp;</p>
              
              <div>
                <?php echo $blogs[0]['content']; ?>
            </div>
